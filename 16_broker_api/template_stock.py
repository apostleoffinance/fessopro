...
# Gets the current datetime in a given timezone (time_zone)
current_time=dt.now(tz=time_zone)
print(current_time)

# This defines the window during which your strategy will run
start_hour,start_min=8,29
end_hour,end_min=8,31
...
# The program loops until the current time reaches the start time.
...
# This loops runs the strategy until the end time is reached
while True:
