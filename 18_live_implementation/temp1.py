...
expected_cols = ['symbol','side','price','quantity','sl','tp']
...
try:
    ...
    trades_info = trades_info[expected_cols]
except FileNotFoundError:
    trades_info = pd.DataFrame(columns=expected_cols)

trades_info.index.name = "Date"
